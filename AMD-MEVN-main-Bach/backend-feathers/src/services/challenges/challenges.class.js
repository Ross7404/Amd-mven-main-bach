...
// Service class for managing challenges with caching
export class ChallengeService extends MongoDBService {
  
  // Override the find method to implement caching
  async find(params) {
    const key = 'challengesCache';
  ...
  async create(data, params) {
    ...
    await redisClient.del('challengesCache');  // Invalidate cache
    return result;
  }
